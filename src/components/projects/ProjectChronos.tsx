...
export const ProjectChronos: React.FC<ProjectChronosProps> = ({ project }) => {
  ...
  return (
    <div
      ...
      className="border border-[#F5F3ED]/15 bg-[#11151A]/70 p-4 sm:p-6 md:p-10 transition-colors duration-300 relative group"
    >
      {/* Top micro metadata header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-[#F5F3ED]/10 text-xs font-editorial-mono">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-4 text-white/60 text-[11px] sm:text-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 pt-6 sm:pt-8 items-start">
        {/* Left Column: Title, Description, Role, System Highlights, Badges */}
        <div className="lg:col-span-12 max-w-5xl space-y-6">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-[#5F0F40]/40 border border-[#F5F3ED]/15 text-[10px] sm:text-[11px] font-editorial-mono text-[#FB8B24] uppercase tracking-wider">
              <Building2 className="w-3.5 h-3.5" />
              <span>MGEN INTERNAL ECOSYSTEM // MS TEAMS</span>
            </div>

            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-editorial-serif text-[#F5F3ED] font-normal tracking-tight group-hover:text-[#FB8B24] transition-colors leading-[1.08] break-words">
              {project.title}
            </h3>
          ...
          <div className="space-y-2.5 pt-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 font-editorial-mono text-xs">
              <div
