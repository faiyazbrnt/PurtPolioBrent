...
export const ProjectList: React.FC<ProjectListProps> = ({ projects }) => {
  return (
    <section
      id="projects-section"
      className="w-full px-4 sm:px-6 md:px-12 lg:px-16 py-12 sm:py-20 md:py-28 border-b border-[#11151A]/10 dark:border-[#F5F3ED]/10 relative bg-transparent transition-colors duration-500"
    >
      <div className="max-w-7xl mx-auto space-y-12 sm:space-y-16">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#11151A]/15 dark:border-[#F5F3ED]/15 pb-5 sm:pb-6">
          ...
          <div className="text-xs font-editorial-mono text-[#11151A]/60 dark:text-white/50 text-left sm:text-right uppercase tracking-wider">
            <span>[ 02 WORKS RECORDED ]</span>
            <span className="block text-[10px] text-[#FB8B24] mt-0.5 font-medium">FILTER: ALL DOMAINS</span>
          </div>
        </div>
