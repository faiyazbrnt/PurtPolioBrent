  ...
  return (
    <AnimatePresence>
      <div
        ...
        className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 md:p-10 bg-black/85 backdrop-blur-md overflow-y-auto"
        onClick={onClose}
      >
        <motion.div
        ...
        >
          ...
          <div className="flex items-center justify-between px-3 sm:px-6 py-2.5 sm:py-4 border-b border-[#F5F3ED]/15 bg-[#171C23] no-print gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              <button
                ...
                aria-label="Copy Resume as Markdown"
              >
                {copied ? (
                  <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-3 sm:gap-4">
                ...
                <div className="text-xs font-editorial-mono space-y-1.5 text-white/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="break-words">{config.location}</span>
                  </div>
                  {config.phone && (
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href={`mailto:${config.email}`} className="hover:text-[#FB8B24] transition-colors underline-offset-2 break-all">
                      {config.email}
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <Github className="w-3.5 h-3.5 text-[#FB8B24] shrink-0" />
                    <a href={config.github} target="_blank" rel="noreferrer" className="hover:text-[#FB8B24] transition-colors break-all">
                      {config.github}
                    </a>
                  </div>
                </div>
          ...
          <div className="px-4 sm:px-6 py-2.5 sm:py-3.5 border-t border-[#F5F3ED]/15 bg-[#171C23] flex flex-row items-center justify-between gap-3 no-print">
            <span className="text-[10px] sm:text-xs font-editorial-mono text-white/40">
              <span className="hidden sm:inline">PRESS [ESC] OR CLICK OUTSIDE TO RETURN</span>
              <span className="sm:hidden">TAP DONE OR OUTSIDE TO CLOSE</span>
            </span>
            <button
              onClick={onClose}
              className="px-4 py-2 bg-[#F5F3ED] text-[#11151A] text-xs font-editorial-mono uppercase tracking-widest font-semibold hover:bg-[#FB8B24] transition-colors shrink-0 cursor-pointer min-h-[36px] flex items-center justify-center"
            >
              DONE
            </button>
          </div>
