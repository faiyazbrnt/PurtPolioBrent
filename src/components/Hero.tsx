...
export const Hero: React.FC<HeroProps> = ({ config, onExploreProjects, onResumeClick }) => {
  return (
    <section
      id="hero-section"
      className="relative w-full min-h-[80vh] lg:min-h-[88vh] flex flex-col justify-between px-4 sm:px-6 md:px-12 lg:px-16 pt-8 sm:pt-12 md:pt-16 pb-10 sm:pb-14 border-b border-[#11151A]/10 dark:border-[#F5F3ED]/10 transition-colors duration-500"
    >
      {/* Background subtle geometric line grid (Swiss aesthetic) */}
      <div
        className="absolute inset-0 pointer-events-none opacity-5 text-[#11151A] dark:text-[#F5F3ED]"
        style={{
          backgroundImage:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-14 items-start">
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <span className="text-[11px] font-editorial-mono tracking-[0.2em] text-[#FB8B24] uppercase font-semibold">
                  INDEX // 001
                </span>
                <span className="w-8 h-[1px] bg-[#FB8B24]/40" />
                <span className="text-[11px] font-editorial-mono tracking-[0.2em] text-[#11151A]/60 dark:text-[#E5E5E5]/60 uppercase">
                  DEV_EDITION
                </span>
              </div>

              <div>
                <h2 className="text-xl md:text-2xl font-light text-[#11151A] dark:text-[#F5F3ED] font-editorial-sans tracking-tight">
                  {config.developerName}
                </h2>
                <p className="text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[#11151A]/70 dark:text-[#E5E5E5]/70 font-editorial-mono mt-1 font-medium sm:font-normal">
                  {config.developerRole}
                </p>
              </div>

              <p className="text-sm leading-relaxed text-[#2B2D42] dark:text-[#D0D0D0] max-w-sm font-normal dark:font-light">
                {config.editorialSubhead}
              </p>
            </div>

            {/* My Skills Specs */}
            <div className="border-t border-[#11151A]/15 dark:border-[#F5F3ED]/15 pt-4 sm:pt-5 space-y-3">
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-editorial-mono tracking-[0.2em] text-[#FB8B24] uppercase font-semibold">
                  MY SKILLS
                </span>
                <span className="w-6 h-[1px] bg-[#FB8B24]/40" />
                <span className="text-[10px] font-editorial-mono tracking-[0.15em] text-[#11151A]/50 dark:text-[#E5E5E5]/50 uppercase">
                  CORE STACK
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 text-xs font-editorial-mono">
                <div>
                  <span className="text-[#11151A]/60 dark:text-white/40 block text-[10px] uppercase tracking-wider mb-0.5">
                    FRONTEND
                  </span>
                  <span className="text-[#11151A] dark:text-[#F5F3ED] break-words font-medium sm:font-normal leading-snug">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 text-xs font-editorial-mono pt-1">
                <div>
                  <span className="text-[#11151A]/60 dark:text-white/40 block text-[10px] uppercase tracking-wider mb-0.5">
                    LANGUAGES
                  </span>
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
              <button
                ...
                className="group inline-flex items-center gap-2 text-xs font-editorial-mono uppercase tracking-[0.2em] text-[#11151A] hover:text-[#FB8B24] dark:text-[#F5F3ED] dark:hover:text-[#FB8B24] transition-colors py-2 font-medium"
              >
          ...
          >
            <div className="space-y-4 sm:space-y-6">
              <div className="inline-flex items-center gap-2.5 sm:gap-3 px-3 py-1.5 border border-[#11151A]/15 dark:border-[#F5F3ED]/15 text-[10px] sm:text-[11px] font-editorial-mono tracking-widest text-[#11151A] dark:text-[#E5E5E5] bg-[#11151A]/5 dark:bg-[#5F0F40]/30 backdrop-blur-sm self-start">
              ...
              */}
              ...
              <div className="pt-2 sm:pt-4 lg:pt-6 max-w-2xl">
                <p className="text-sm sm:text-base md:text-lg text-[#2B2D42] dark:text-[#D0D0D0] leading-relaxed font-normal dark:font-light">
      ...
      <div className="max-w-7xl mx-auto w-full pt-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs font-editorial-mono text-[#11151A]/60 dark:text-white/40 border-t border-[#11151A]/10 dark:border-[#F5F3ED]/10">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden sm:inline-block text-[#FB8B24]">
